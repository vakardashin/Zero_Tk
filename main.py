...
def mark_task():
    selected_task = task_listBox.curselection()
    if selected_task:
        task_listBox.itemconfig(selected_task, bg="green3")
...
text2 = tk.Label(root, text="Список задач", bg="SteelBlue3")
text2.pack(pady=5)

task_listBox = tk.Listbox(root, height=10, width=50, bg="SteelBlue1")
